        ...
        <template slot="content">
          ...
          >
            <el-form-item prop="itemName" label="商品名称">
              <el-input v-model="addModel.itemName" v-if="this.addModel.editType === '1'" :disabled=true></el-input>
              <el-input v-model="addModel.itemName" v-if="this.addModel.editType === '0'"></el-input>
            </el-form-item>
