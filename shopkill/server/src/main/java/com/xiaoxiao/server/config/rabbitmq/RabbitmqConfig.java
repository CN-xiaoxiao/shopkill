package com.xiaoxiao.server.config.rabbitmq;
...
//        factory.setBatchSize(1);
    ...
    public RabbitTemplate rabbitTemplate(){
        ...
        rabbitTemplate.setConfirmCallback((correlationData, b, s) -> log.info("消息发送成功:correlationData({}),b({}),s({})",correlationData, b, s));

        rabbitTemplate.setReturnsCallback(returnedMessage -> log.warn("消息丢失:exchange({}),route({}),replyCode({}),replyText({}),message:{}",
